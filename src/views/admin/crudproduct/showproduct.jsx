...
export default function Showproduct() {
    ...
    const addtocart = (product) => {
        ...
        // localStorage.setItem("notrepannier", JSON.stringify([...carts, product]));
                        ...
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <div className="flex mb-4">
                                <span className="flex items-center">
                                    ...
                                    <svg fill="currentColor" stroke="currentColor" stroklinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-4 h-4 text-red-500" viewBox="0 0 24 24">
                                        <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"></path>
                                    </svg>
                            ...
                            <div className="flex">
                                <span className="title-font font-medium text-2xl text-gray-900">{product.price} DT</span>
                                <button onClick={() => addtocart(product)} className="flex ml-auto text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded">ADD TO CART</button>
